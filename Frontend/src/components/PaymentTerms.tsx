                        ...
                        <div className="space-y-8">
                            <section>
                                ...
                                <p className="text-slate-600 leading-relaxed">
                                    These Payment Terms govern all payments made to eval8 ai ("we," "our," or "us") for the use of our services. By making a payment, you agree to these Payment Terms and our Terms of Service.
                                </p>
                            </section>
                            ...
                            <section>
                                ...
                                <p className="text-slate-600 leading-relaxed">
                                    If you believe that you have been charged incorrectly, please contact us at talent@eval8 ai.ai within 30 days of the charge. We will review your concerns and work to resolve any legitimate issues promptly.
                                </p>
                            </section>
