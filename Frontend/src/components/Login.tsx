      ...
      <div className="relative z-10 w-full max-w-md mx-4">
        ...
        <div className="bg-white/10 backdrop-blur-xl rounded-3xl p-8 shadow-2xl border border-white/20">
          <div className="text-center mb-5">
            ...
            <p className="text-base text-primary/80">Sign in to your account</p>
          </div>

          <div className="bg-white/5 backdrop-blur-xl rounded-2xl p-1.5 flex gap-1.5 mb-6 border border-white/10">
            <Button className="flex-1 bg-primary text-white hover:bg-orange-500 shadow-lg text-sm py-4">
              Sign In
            </Button>
            <Button
              variant="ghost"
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex items-center justify-between py-2">
              <label className="flex items-center">
                <input type="checkbox" className="rounded border-white/20 bg-white/5 text-primary focus:ring-primary h-4 w-4" />
                <span className="ml-2 text-primary/80 text-sm">Remember me</span>
              </label>
              <Link to="/forgot-password" className="text-primary hover:text-orange-500 text-sm">
                Forgot password?
              </Link>
            </div>
            ...
            <Button
              type="submit"
              className="w-full h-11 bg-primary hover:bg-orange-500 text-white text-base rounded-xl shadow-lg transition-all duration-200 hover:shadow-xl"
              disabled={isLoading}
            >
