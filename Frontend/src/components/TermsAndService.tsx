                        ...
                        <div className="space-y-8">
                            <section>
                                ...
                                <p className="text-slate-600 leading-relaxed">
                                    Welcome to eval8 ai ("we," "our," or "us"). These Terms of Service ("Terms") govern your access to and use of the eval8 ai website, applications, and services (collectively, the "Services").
                                </p>
                            ...
                            <section>
                                ...
                                <p className="text-slate-600 leading-relaxed">
                                    All content, features, and functionality of the Services, including but not limited to text, graphics, logos, icons, images, audio clips, and software, are owned by eval8 ai or its licensors and are protected by copyright, trademark, and other intellectual property laws.
                                </p>
                            </section>
                            ...
                            <section>
                                ...
                                <p className="text-slate-600 leading-relaxed">
                                    To the maximum extent permitted by law, in no event shall eval8 ai be liable for any indirect, incidental, special, consequential, or punitive damages, including without limitation, loss of profits, data, use, goodwill, or other intangible losses, resulting from your access to or use of or inability to access or use the Services.
                                </p>
                            </section>
