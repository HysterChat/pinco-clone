...
const FAQ = () => {
    const faqs = [
        {
            question: "What is eval8?",
            answer: "eval8 is an AI-powered mock interview platform where you can practice HR, Technical, and Versant interviews anytime with instant feedback."
        },
        {
        ...
        },
        {
            ...
            answer: "eval8 is built especially for both freshers and experienced candidates to build interview confidence, communication skills, and job readiness."
        },
        {
            question: "Can I use eval8 on my phone?",
