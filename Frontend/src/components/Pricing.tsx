                ...
                >
                    ...
                    >
                        ...
                        <ul className="space-y-4 mb-8">
                            {freePlan?.features?.map((feature, index) => (
                                <li key={index} className="flex items-start text-primary/90">
                                    <Check className="h-5 w-5 text-orange-500 mr-3 flex-shrink-0 mt-1" />
                                    <span>{feature}</span>
                                </li>
                            ))}
                        </ul>
                        <Button
                            ...
                            className="w-full py-3 md:py-6 bg-primary hover:bg-orange-500 text-white rounded-lg shadow-md transition-transform transform hover:scale-[1.02]"
                        >
                            Get Started
                        </Button>
                    </motion.div>
                    ...
                    <motion.div
                        variants={itemVariants}
                        className="relative bg-primary/10 backdrop-blur-lg rounded-2xl p-6 md:p-8 shadow-lg border border-orange-500 ring-2 ring-orange-500 transform hover:-translate-y-2 transition-all duration-300"
                    >
                        <div className="absolute top-0 right-0 -mt-4 mr-4 px-3 py-1 bg-orange-500 text-white text-sm font-semibold rounded-full shadow-md">
                            Most Popular
                        </div>
                        ...
                        <Button
                            onClick={handlePlanClick}
                            className="w-full py-3 md:py-6 bg-orange-500 hover:bg-primary text-white rounded-lg shadow-md transition-transform transform hover:scale-[1.02]"
                        >
                            Upgrade Now
                        </Button>
                    </motion.div>
