                        ...
                        <div className="space-y-8">
                            <section>
                                ...
                                <p className="text-slate-600 leading-relaxed">
                                    At eval8, we value your privacy and are committed to protecting your personal information. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our website, applications, and services (collectively, the "Services").
                                </p>
