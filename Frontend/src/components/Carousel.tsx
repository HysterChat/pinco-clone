...
const carouselData: CarouselItem[] = [
  {
    ...
    description: "You've prepared for days, but the words don't come out. eval8 helps you stay calm and speak clearly.",
  ...
  },
  {
    ...
    description: "Rejections without explanation leave you guessing. eval8 tells you exactly what went wrong—instantly.",
  ...
  },
  {
    ...
    description: "eval8 helps you build fluency and confidence without pressure. Practice daily and see the change.",
  ...
  },
  {
    ...
    description: "A great resume opens the door. Your interview performance keeps it open. Practice both with eval8.",
    ctaText: "Train With eval8 Like a Pro",
    ctaLink: "/signup",
