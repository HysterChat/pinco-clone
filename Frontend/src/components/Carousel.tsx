          ...
          >
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="text-center text-white px-4 max-w-5xl mx-auto">
                ...
                <a
                  href={item.ctaLink}
                  className="inline-block bg-primary hover:bg-orange-500 text-white text-xl md:text-2xl font-bold py-4 px-10 rounded-full transition-all duration-300 transform hover:scale-105 hover:shadow-lg"
                >
                  {item.ctaText}
                </a>
              </div>
