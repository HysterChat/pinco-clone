    ...
    return (
        <div className="bg-[#0f172a] py-16 md:py-24">
            <div className="max-w-4xl mx-auto px-4 py-12">
                ...
                {/* Our Story */}
                <div className="mb-16">
                    <h2 className="text-2xl font-bold text-[#1E1B4B] mb-6">Our Story</h2>
                ...
                {/* Mission & Values */}
                <div>
                    <h2 className="text-2xl font-bold text-[#1E1B4B] mb-6">Our Mission & Values</h2>
                    <div className="grid md:grid-cols-3 gap-6">
                        <div className="bg-white rounded-xl p-6">
                            <div className="mb-4">
                                <Target className="h-6 w-6 text-[#4F46E5]" />
                            </div>
                            <h3 className="text-lg font-semibold text-[#1E1B4B] mb-2">Mission</h3>
                            <p className="text-[#1E1B4B]/70">
                        ...
                        <div className="bg-white rounded-xl p-6">
                            <div className="mb-4">
                                <Star className="h-6 w-6 text-[#4F46E5]" />
                            </div>
                            <h3 className="text-lg font-semibold text-[#1E1B4B] mb-2">Excellence</h3>
                            <p className="text-[#1E1B4B]/70">
                        ...
                        <div className="bg-white rounded-xl p-6">
                            ...
                            <h3 className="text-lg font-semibold text-[#1E1B4B] mb-2">Inclusivity</h3>
                            <p className="text-[#1E1B4B]/70">
                ...
                {/* CTA Section */}
                <div className="mt-16 bg-[#4F46E5]/20 rounded-xl p-8 text-center">
