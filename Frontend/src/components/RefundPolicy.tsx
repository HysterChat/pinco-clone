                        ...
                        <div className="space-y-8">
                            <section>
                                ...
                                <p className="text-slate-600 leading-relaxed">
                                    This Refund Policy explains how and when you can request a refund for services purchased from eval8 ("we," "our," or "us"). By using our services, you agree to the terms of this Refund Policy.
                                </p>
                            </section>
                            ...
                            <section>
                                ...
                                <p className="text-slate-600 leading-relaxed mb-4">
                                    To request a refund, please contact our customer support team at talent@eval8.in. Please include your account information, the name of the service purchased, and the reason for your refund request.
                                </p>
                                <p className="text-slate-600 leading-relaxed">
                            ...
                            <section>
                                ...
                                <ul className="list-disc pl-6 space-y-2 text-slate-600">
                                    ...
                                    <li>For any technical issues that are not directly attributable to eval8</li>
                                </ul>
                            </section>
